...
function ImageUploader() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 p-6 bg-white rounded-xl shadow-md">
      ...
      <div 
        {...getRootProps()}
        className={`w-full md:w-1/2 h-64 border-2 border-dashed rounded-lg flex items-center justify-center cursor-pointer transition-colors
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-600">
            {isDragActive ? '松开鼠标上传' : '拖放图片至此或点击选择'}
          </p>
